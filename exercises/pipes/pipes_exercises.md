...
<details>
<summary style="color: darkred" >Натисни за обяснения по регулярния израз!</summary>
^ и $ са начало и край на реда съответно. 
Те гарантират, че целият израз отговаря на цял ред от входните данни, а не само на част от него.

([a-zA-Z0-9]+\.)* е група, която съответства на една или повече букви или цифри, последвани от точка.
Този шаблон може да се повтори нула или повече пъти, което позволява съвпадение с поддомейни в email адреса.

[a-zA-Z0-9_-]+ съответства на една или повече букви, цифри, подчертавки или тирета. 
Това е частта на адреса преди символа @.

@ е символът, който разделя името на потребителя от домейна в email адреса.

([a-zA-Z0-9]+[a-zA-Z0-9-]*[a-zA-Z0-9]+\.)* е група, която съответства на домейни и поддомейни. 
Тя започва и завършва с една или повече букви или цифри, с разрешено тире между тях, последвано от точка. 
Това позволява съвпадение с комплексни домейни, като същевременно изисква 
домейните да започват и завършват с буква или цифра, за да избегне съвпадение с невалидни домейни като тези,
които завършват с тире.

[a-zA-Z0-9]+ в края съответства на топ ниво домейна, който се състои изцяло от една или повече букви или цифри.
